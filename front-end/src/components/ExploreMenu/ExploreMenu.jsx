    ...
    return (
        <div className='explore_menu' id='explore_menu'>
            ...
            <p className='explore_menu_text'>
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Iusto voluptate obcaecati veritatis vitae facere excepturi magni minima tenetur iure enim, ad nobis fugiat provident laboriosam.
            </p>
